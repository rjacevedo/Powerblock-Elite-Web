...
urlpatterns = patterns('',
    ...
    url(r'^updateCircuit/(?P<circuitNum>[0-9]+)/(?P<value>[0-1])/$', 'PbElite.views.updateCircuit'), 
    url(r'^circuits/', 'PbElite.views.grabCircuits'),            
    ...
    url(r'^api/grabReadings/', 'PbElite.views.grabReadings'),

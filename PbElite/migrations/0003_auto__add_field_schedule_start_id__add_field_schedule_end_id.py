...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Schedule.start_id'
        db.add_column(u'PbElite_schedule', 'start_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['djcelery.PeriodicTask']),
                      keep_default=False)

        # Adding field 'Schedule.end_id'
        db.add_column(u'PbElite_schedule', 'end_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['djcelery.PeriodicTask']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Schedule.start_id'
        db.delete_column(u'PbElite_schedule', 'start_id_id')

        # Deleting field 'Schedule.end_id'
        db.delete_column(u'PbElite_schedule', 'end_id_id')
